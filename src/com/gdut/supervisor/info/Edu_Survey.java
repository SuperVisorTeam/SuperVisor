...
/***********************************************************************
 * Module:  edu_Survey.java
 * Author:  zhh
 * Purpose: Defines the Class edu_Survey
 ***********************************************************************/
/**
 * edu_Survey | 学风督导信息
 * 
 */
public class Edu_Survey {
	/**
	 * 当时督导时间
	 */
	...
	// public Collection<Oa_Emailbody> oa_emailbody;
	//
	// public Edu_CourseClass edu_CourseClass;

	// @Id
	// @GeneratedValue(generator = "autoSequenceIdGenerator")
	// @GenericGenerator(name = "autoSequenceIdGenerator", strategy =
	// "com.cscw.utils.AutoSequenceIdGenerator")
	...
	// @JoinColumn(name = "course_class_no")
	public Edu_CourseClass getCourse_class_no() {
		return course_class_no;
	}

	public void setCourse_class_no(Edu_CourseClass course_class_no) {
	...
	// public Collection<Oa_Emailbody> getOa_emailbody() {
	// return oa_emailbody;
	// }
	//
	// public void setOa_emailbody(Collection<Oa_Emailbody> oa_emailbody) {
	// this.oa_emailbody = oa_emailbody;
	// }
	//

	// @ManyToOne(fetch=FetchType.EAGER)
	// public Edu_CourseClass getEdu_CourseClass() {
	// return edu_CourseClass;
	// }
	//
	// public void setEdu_CourseClass(Edu_CourseClass edu_CourseClass) {
